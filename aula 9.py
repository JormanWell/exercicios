# Calcular numero de latas necessárias
...
#    litros = litros + 1
#    if litros // 4 < 1:
        #print("Precisa de 1 lata de 4 litros")3
#else:
 #   litros // 18 < 1
 #   latas4 = litros // 4
  #  if latas4 % 4 > 0:
   #     latas4 = latas4 +1
       # print("Precisa de", latas4, "latas de 4 litros.")
#if litros // 18 > 1:

    
    
 #   print("Precisa de 1 lata de 18 e" latas4, "latas de 4 litros")
